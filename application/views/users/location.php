            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  <h4 class="card-title">Lokasi Absen Masuk</h4>
                  <div class="card-category" id="longdat"><?php echo $dat['Longitude']; ?></div>
                  <div class="card-category" id="latdat"><?php echo $dat['Latitude'];?></div>
                </div>
                <div class="card-body">
                    <div class="row">
